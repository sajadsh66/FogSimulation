# drop packets that obviously will exceed their delay threshold
# change buffers to priority buffers (on the TTL of tasks)
        ...
        while True:
            ...
            if msg.task_or_resp == "task":
                if msg.fstc: # if force send to cloud flag is True, send it to cloud directly
                    ...
                    if temp == 0 or ((self.estimated_waiting_time + p_time) < temp and (self.estimated_waiting_time + p_time) >= msg.TTL): # process itself
...
if __name__ == '__main__':
    ...
    # with open("enhance3.txt", "wb") as fp:  # Pickling
